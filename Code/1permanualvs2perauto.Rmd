...
```{r}
manualauto <- read.csv("../Data/1permanualvs2perauto.csv")
```
...
```{r}
ggplot(data = manualauto, aes(x = Day, y = EggCounts, fill = Condition)) + 
  geom_boxplot() +
  theme_prism(base_size = 10) +
  theme(legend.text = element_text(size = 10, face = "bold"), legend.position = c(0.8,0.8)) +
